...
const STRINGS: Record<string, LocaleStrings> = {
  ...
  da: {
    ...
    joinButton: /opret dig|tilmeld|opret konto|deltag/i, // confirmed live: GC's header button reads "OPRET DIG", MC's reads "TILMELD", Ice36 (I36)'s reads "Deltag" (confirmed live 2026-08-05) — four genuinely different brand copies, same language, same shared-by-locale pattern. "opret konto" added 2026-08-05 for Simba Games (SG) DK, whose real header button reads "Opret Konto"
